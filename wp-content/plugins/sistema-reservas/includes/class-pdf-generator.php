...
class ReservasPDFGenerator {
    ...
    if (!class_exists('TCPDF')) {
        ...
        // Opción 2: Manual
        elseif (file_exists(RESERVAS_PLUGIN_PATH . 'vendor/tcpdf/tcpdf.php')) {
        ...
        elseif (file_exists('/usr/share/php/tcpdf/tcpdf.php')) {
            ...
            throw new Exception('TCPDF no está disponible. Por favor instala la librería TCPDF.');
        }
    }
}
